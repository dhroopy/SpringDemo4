...
<div align="center">
			<form name="Info" action="" method="post">
				<table border=0 style="background-color: H0080FF80;">
					...
					<tr>
						<td align="center"><input type="text" name="withdamt" placeholder="Withdrawal Amount" autofocus="autofocus" style="width: 162px; "></td>
					</tr>
					<tr>
						<td align="center"><input type="Submit" value="Withdraw" style="width: 162px; "></td>
					</tr>
					<tr>
